...
function installconstellation {
  ...
  then
    ...
    wget https://github.com/jpmorganchase/constellation/releases/download/v0.3.5-build.1/constellation-0.3.5-ubuntu1604.tar.gz -O /tmp/$constellationrel.tar.xz
    pushd /tmp
